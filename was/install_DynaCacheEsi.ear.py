...
if applicationInstalled == 'false':
  result = AdminApp.install(os.environ['WAS_HOME'] + '/installableApps/DynaCacheEsi.ear', '[ -appname DynaCacheEsi -MapModulesToServers [[ DynaCacheEsi DynaCacheEsi.war,WEB-INF/web.xml ' + mapModulesToServers + ' ]]]' )
