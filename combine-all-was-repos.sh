...
#        /srv/install/wasfps/85512/was\'
#        /srv/install/ibmwasjava/7041\'
#        /srv/install/ibmwasjava/70105\'
#        /srv/install/ibmwasjava/7145\'
#        /srv/install/ibmwasjava/8045'
# 2987    /srv/install/was/8550'
# 4308    /srv/install/wasfps/85512/was'
# 2183    /srv/install/ibmwasjava/7041'
# 2320    /srv/install/ibmwasjava/70105'
# 2042    /srv/install/ibmwasjava/7145'
# 2558    /srv/install/ibmwasjava/8045'
# 
# ... to this:'
# du -sm /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512'
# 2402    /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512'
# 
# Its done with the IBM Packaging Utility by only selecting the packages required to install WAS 8.5.5.12 (incl Java 7.0, 7.1, and 8.0) to a given OS, and platform'
# 
...
echo 'Create a combined repository with WAS ND (only) 8.5.5.12 incl all java versions, but restrict architecture to Linux x86_64, and Linux PPC64.'
/opt/IBM/PackagingUtility/PUCL copy com.ibm.websphere.ND.v85 \
 ...
 -repositories /net/files/srv/install/was/8550,/net/files/srv/install/wasfps/85512/was\
 -target /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512/\
 -acceptLicense\
 -showVerboseProgress && \
/opt/IBM/PackagingUtility/PUCL copy com.ibm.websphere.IBMJAVA.v70\
 -platform os=linux,arch=x86,os=linux,arch=x86_64,os=linux,arch=ppc,os=linux,arch=ppc64\
 -repositories /net/files/srv/install/ibmwasjava/7041,/net/files/srv/install/ibmwasjava/70105\
 -target /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512/\
 -acceptLicense\
 -showVerboseProgress && \
/opt/IBM/PackagingUtility/PUCL copy com.ibm.websphere.IBMJAVA.v71\
 -platform os=linux,arch=x86,os=linux,arch=x86_64,os=linux,arch=ppc,os=linux,arch=ppc64\
 -repositories /net/files/srv/install/ibmwasjava/7145\
 -target /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512/\
 -acceptLicense\
 -showVerboseProgress && \
/opt/IBM/PackagingUtility/PUCL copy com.ibm.websphere.IBMJAVA.v80\
 -platform os=linux,arch=x86,os=linux,arch=x86_64,os=linux,arch=ppc,os=linux,arch=ppc64\
 -repositories /net/files/srv/install/ibmwasjava/8045\
 -target /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512/\
 -acceptLicense\
 -showVerboseProgress

echo 'check that all packages are available'
/opt/IBM/PackagingUtility/PUCL listAvailablePackages -repositories /net/files/srv/install/was-combined-linux_x86-64_ppc64-85512
...
echo ' -log /tmp/install-was85512-log.xml\'
echo ' -nl en\'
echo ' -record /tmp/install-was85512-response.xml\'
echo ' -repositories http://ftp.example.com/srv/install/was-combined-linux_x86-64-85512\'
