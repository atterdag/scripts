...
<IfModule mod_ibm_ssl.c>
  Listen 0.0.0.0:443
  <VirtualHost *:443>
    ServerName $HOSTNAME.dmz.example.com
    #DocumentRoot htdocs
  ...
  SSLServerCert $HOSTNAME.dmz.example.com

  # Server configuration default keystore
  Keyfile "/opt/IBM/HTTPServer/conf/$HOSTNAME.dmz.example.com.kdb"

  # Default keystore stash file
  SSLStashFile "/opt/IBM/HTTPServer/conf/$HOSTNAME.dmz.example.com.sth"
</IfModule>
...
<IfModule mod_rewrite.c>
  ...
  RewriteRule /(.*)/ibm_security_logout(.*) //ibm_security_logout?logoutExitPage=http://$HOSTNAME.dmz.example.com/ihs-index.html [noescape,L,R]
</IfModule>
EOF
