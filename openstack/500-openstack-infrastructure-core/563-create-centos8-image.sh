...
sudo wget \
  --continue \
  --output-document=${OPENSTACK_IMAGES_DIRECTORY}/CentOS-8-GenericCloud-8.1.1911-20200113.3.x86_64.qcow2 \
  https://cloud.centos.org/centos/8/x86_64/images/CentOS-8-GenericCloud-8.1.1911-20200113.3.x86_64.qcow2

openstack image create \
  --container-format bare \
  --disk-format qcow2 \
  --file ${OPENSTACK_IMAGES_DIRECTORY}/CentOS-8-GenericCloud-8.1.1911-20200113.3.x86_64.qcow2 \
  --public \
