...
CONTEXT=KUARD
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /variables/${CONTEXT}_HOST_NAME 'kuard'
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /variables/${CONTEXT}_IP_ADDRESS '192.168.1.224'
