...
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/SSL_INTERMEDIATE_OCTAVIA_CLIENT_CA_PASSWORD $(genpasswd 32)
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/SSL_INTERMEDIATE_OCTAVIA_SERVER_CA_PASSWORD $(genpasswd 32)
