...
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/MAAS_PG_REPLICATION_PASSWORD $(genpasswd 32)
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/MAAS_DBPASS $(genpasswd 32)
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/MAAS_ADMIN_PASSWORD $(genpasswd 32)
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/MAAS_SECRET $(genpasswd 32)
...
etcdctl --username admin:"$ETCD_ADMIN_PASS" set /passwords/DOCKER_REGISTRY_PASSWORD $(genpasswd 32)
