...
# sudo crudini --set /etc/glance/glance-api.conf keystone_authtoken www_authenticate_uri "http://${CONTROLLER_FQDN}:5000"
sudo crudini --set /etc/glance/glance-api.conf keystone_authtoken auth_url "https://${CONTROLLER_FQDN}:5000"
# sudo crudini --set /etc/glance/glance-api.conf keystone_authtoken auth_url "http://${CONTROLLER_FQDN}:5000"
