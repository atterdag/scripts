...
##############################################################################
cat << EOF | sudo tee ${OPENSTACK_CONFIGURATION_DIRECTORY}/keystone.sql
CREATE DATABASE keystone;
GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'localhost' IDENTIFIED BY '${KEYSTONE_DBPASS}';
GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'%' IDENTIFIED BY '${KEYSTONE_DBPASS}';
EXIT
EOF
sudo chmod 0600 ${OPENSTACK_CONFIGURATION_DIRECTORY}/keystone.sql
sudo cat ${OPENSTACK_CONFIGURATION_DIRECTORY}/keystone.sql \
