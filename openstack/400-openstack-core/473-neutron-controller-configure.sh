...
# sudo crudini --set /etc/neutron/neutron.conf keystone_authtoken www_authenticate_uri "http://${CONTROLLER_FQDN}:5000"
sudo crudini --set /etc/neutron/neutron.conf keystone_authtoken auth_url "https://${CONTROLLER_FQDN}:5000"
# sudo crudini --set /etc/neutron/neutron.conf keystone_authtoken auth_url "http://${CONTROLLER_FQDN}:5000"
...
# sudo crudini --set /etc/neutron/neutron.conf nova auth_url "http://${CONTROLLER_FQDN}:5000"
...
sudo crudini --set /etc/neutron/plugins/ml2/linuxbridge_agent.ini linux_bridge physical_interface_mappings "provider:${CONTROLLER_PROVIDER_NIC}"
...
# sudo crudini --set /etc/nova/nova.conf neutron auth_url "http://${CONTROLLER_FQDN}:5000"
...
sudo crudini --set /etc/neutron/plugins/ml2/ml2_conf.ini ml2_type_vlan network_vlan_ranges "${CONTROLLER_PROVIDER_NIC}:1:4094"
