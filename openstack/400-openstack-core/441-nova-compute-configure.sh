...
sudo crudini --set /etc/nova/nova.conf placement certfile "/etc/ssl/certs/${COMPUTE_FQDN}.crt"
sudo crudini --set /etc/nova/nova.conf placement keyfile "/etc/ssl/private/${COMPUTE_FQDN}.key"
