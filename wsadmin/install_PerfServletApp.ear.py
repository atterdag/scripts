...
if applicationInstalled == 'false':
    result = AdminApp.install(
        os.environ['WAS_HOME'] + '/installableApps/PerfServletApp.ear',
        '[ -appname perfServletApp -MapModulesToServers [[ perfservlet perfServletApp.war,WEB-INF/web.xml '
        + mapModulesToServers + ' ]]]')
...
result = AdminApp.edit(
    'perfServletApp',
    '[ -MapRolesToUsers [[ monitor AppDeploymentOption.No AppDeploymentOption.No "" '
    + perfServletAppMonitorGroupCN + ' AppDeploymentOption.No "" group:' +
    realmName + '/' + perfServletAppMonitorGroupDN + ' ]]]')
