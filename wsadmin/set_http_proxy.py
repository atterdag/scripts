...
if ( wasJvmHttpProxyUser =! "" ):
    if ( wasJvmHttpProxyPassword == "" ):
      ...
      sys.exit(102)
    setJvmCustomProperties(server, [[['name', 'http.proxyUser'], ['value', wasJvmHttpProxyUser]]])
    setJvmCustomProperties(server, [[['name', 'http.proxyPassword'], ['value', wasJvmHttpProxyPassword]]])
    setJvmCustomProperties(server, [[['name', 'https.proxyUser'], ['value', wasJvmHttpProxyUser]]])
    setJvmCustomProperties(server, [[['name', 'https.proxyPassword'], ['value', wasJvmHttpProxyPassword]]])
